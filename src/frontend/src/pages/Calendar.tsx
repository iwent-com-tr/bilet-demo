      ...
      <div className="container mx-auto px-4 py-4 sm:py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8">
          ...
          <div className="lg:sticky lg:top-8">
            ...
            <div className={`mt-4 bg-white rounded-lg shadow p-4 ${selectedDate ? 'hidden lg:block' : ''}`}>
              <h3 className="text-sm font-medium text-gray-700 mb-2">Nasıl kullanılır?</h3>
              ...
              <div>
                ...
                <div className="lg:hidden mb-4">
                  <button
                    ...
                    className="flex items-center text-primary-600 hover:text-primary-700 transition-colors touch-manipulation"
                  >
